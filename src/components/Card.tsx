import "./card.css";
import { ICardProps } from "../utils/utlity";
...
const Card = ({
  ...
  return (
    <div className="cardContainer" onClick={()=>selectCard(index)}   style={{
      ...
      gridRowEnd: height < 3800 ? 'span 1' : 'span 2'
    }}>
      <div>
      ...
      <div className="cardConatinerSecond centerItemsVertically">
        <div className="cardLeft centerItemsVertically">
        ...
        <div className="cardRight centerItemsVertically">
          <button>
